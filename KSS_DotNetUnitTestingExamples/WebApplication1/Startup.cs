...
namespace WebApplication1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPie2Service, Pie2Service>();
            services.AddTransient<IPieDataService, PieDataService>();
            services.AddTransient<IPie2DataService, Pie2DataService>();
            services.AddSingleton<IPastryService, PastryService>();
            services.AddSingleton<IFillingService, FillingService>();
            services.AddSingleton<INowAdapter, NowAdapter>();
        }
